...
const UNSPLASH = {
  ...
  sweater: '1576566588028-4147f3842f27',
...
function viewProduct(id) {
  ...
  <div class="wrap" style="padding-top:20px">
    <div class="crumbs"><a href="index.html">Home</a><span>/</span><a href="shop.html?cat=${p.cat}">${CATS.find(c => c[0] === p.cat)[1]}</a><span>/</span><span>${p.name}</span></div>
  </div>
  <div class="pd">
...
function view404() {
  return `<div class="wrap sec" style="text-align:center"><span class="eyebrow">404</span><h1 style="margin-top:14px">Off the map</h1><p style="color:var(--paper-dim);margin-top:12px">That page doesn't exist. <a href="index.html" style="color:var(--gold)">Back home →</a></p></div>`;
}
